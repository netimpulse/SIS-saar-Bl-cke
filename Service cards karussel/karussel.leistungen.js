/* karussel.leistungen – Endless Carousel
   Nutzt bestehendes Markup:
   .svc-wrap[data-svc-carousel] > .svc-inner > .svc-scroller > .svc-row > .svc-card
   - Endlosschleife durch Clones
   - Pfeile blättern seitenweise
   - Maus-Drag (Desktop) & Touch-Scroll (Mobil)
   - CSS Snap bleibt aktiv
*/
...
(function () {
  ...
  function initCarousel(root) {
    ...
    // Cleanup (Theme-Editor kann neu rendern)
    ...
    arrows.forEach((btn)=>{
      btn.addEventListener('click', ()=>{
        ...
        scrollByCards(dir, visibleCount()); // seitenweise
      });
    });
